...
dagshub.init(repo_owner='bhattpriyang', repo_name='mini-project', mlflow=True)

mlflow.set_experiment("water_potability_final")

mlflow.set_tracking_uri("https://dagshub.com/bhattpriyang/mini-project.mlflow")
